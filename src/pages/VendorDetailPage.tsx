        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8, marginTop: 20 }}>
              ...
              <button onClick={() => { setShowEditModal(false); setSaved(true); setTimeout(() => setSaved(false), 2000); }} style={{ padding: '9px 14px', fontSize: 12.5, fontWeight: 700, color: '#FFFFFF', background: '#1A5C58', border: 'none', borderRadius: 9, cursor: 'pointer' }}>Save</button>
            </div>
          </div>
        </>
      )}
      ...
      {showPinModal && (
        <>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 16, fontWeight: 700, color: '#2C3E50', marginBottom: 16 }}>Reset PIN for {vendor.name}</div>
            <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8, marginTop: 20 }}>
              ...
              <button onClick={() => { setShowPinModal(false); setNewPin(''); setSaved(true); setTimeout(() => setSaved(false), 2000); }} disabled={!newPin} style={{ padding: '9px 14px', fontSize: 12.5, fontWeight: 700, color: '#FFFFFF', background: newPin ? '#1A5C58' : '#94A3B8', border: 'none', borderRadius: 9, cursor: newPin ? 'pointer' : 'not-allowed' }}>Reset PIN</button>
            </div>
          </div>
        </>
      )}
